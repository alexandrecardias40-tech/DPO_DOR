...
export default function KPIs() {
  ...
  const renderPieLabel = useCallback(
    (props: PieLabelRenderProps) => {
      ...
      const labelRadius = safeOuterRadius + 42;
      const x = safeCx + labelRadius * Math.cos(-safeMidAngle * RAD);
      const y = safeCy + labelRadius * Math.sin(-safeMidAngle * RAD);
      const textAnchor = x > safeCx ? "start" : "end";
