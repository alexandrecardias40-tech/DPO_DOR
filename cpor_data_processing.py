...
"Valor_Mensal_Continuado": (
    "valor_mensal_continuado", 
    "valor_continuado", 
    "valor_continuado_mensal", 
    "valor_cont_continuado_mensal",
    "continuado_mensal",
),
...
"Saldo_Empenhos_2025": (
    ...
    "saldo_2025",
    "saldo_empenho_2025",
    "despesas_empenhadas_a_liquidar_controle_emp",
    "saldo_empenhos_2026",
    "saldo_2026",
    "saldo_empenho_2026",
    "empenhos_2025",
...
"Saldo_Empenhos_RAP": (
    "saldo_empenhos_rap",
    "saldo_de_empenhos_rap",
    "saldo_rap",
    "restos_a_pagar_nao_processados_a_liquidar",
    "rap",
    "empenhos_rap",
    "restos_pagar",
),
...
class FixedLookup:
    def __init__(self, dataframe: Optional[pd.DataFrame]):
        ...
        # Load Fallback Data first (can be overwritten by dataframe)
        self._load_fallback()
    ...
    def _load_fallback(self):
        for pi, data in FALLBACK_FIXED_DATA.items():
            pi_key = _clean_key(pi)
            if pi_key:
                record = data.copy()
                record["PI_2025"] = pi
    ...
    def match(self, row: Dict[str, object]) -> Optional[Dict[str, object]]:
        ...
        if pi_key:
            ...
            # If fallback exists and file match ambiguous? 
            # Fallback is in by_pi.
            return candidates[0]
        return None
...
def _build_monthly_consumption(rows: Sequence[Dict[str, object]], month_keys: Sequence[str]) -> List[Dict[str, object]]:
    ...
    for key in sorted(month_keys):
        ...
        result.append({"Mes": label, "Consumo_Mensal": totals[key]})
    return result
    ...
    for row in rows:
        ...
        stats = bucket.setdefault(
            key,
            {
                ...
                "Saldo_Empenhos_2025": 0.0,
                "Saldo_Empenhos_RAP": 0.0,
                "Contratos_Ativos": 0,
        ...
        # Raw value extraction for breakdown
        ...
        stats["Saldo_Empenhos_2025"] += s25
        stats["Saldo_Empenhos_RAP"] += srap
